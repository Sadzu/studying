...
public class Serializer implements Serializable {
    ...
    public static void serializeToSocket(ObjectOutputStream out, Object object) {
        try {
            out.writeObject(object);
        } catch (IOException e) { e.printStackTrace(); }
    }

    public static Serializer deserializeFromSocket(ObjectInputStream in) {
        try {
            Serializer res = (Serializer) in.readObject();
            return res;
